% script to convert OVD infromstion provided by the classification
% algorithms to OVD FEature Files
% J. Bitzer, BSD Licence
...
% this has to be edapted to your needs
...
% loop over all OVD Data
for kk = 1:length(AllParticipantsOVD) % this will be the outer loop in the end over all participants
